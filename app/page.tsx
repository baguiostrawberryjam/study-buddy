...
export default function Home() {
  ...
  return (
    ...
    <Default className="flex flex-col h-screen overflow-hidden bg-white dark:bg-[#0a0a0a] text-gray-900 dark:text-gray-100" hideStageLights={isChatStarted}>

      {/* Main Content Area */}
      <div className={`
        flex-1 flex flex-col items-center w-full max-w-6xl mx-auto px-4 sm:px-6 min-h-0 overflow-hidden
      ...
      `}>
        ...
        <div className={`
          ...
          ${isChatStarted ? 'flex-1 min-h-0 opacity-100 translate-y-0 overflow-hidden' : 'flex-none opacity-100 translate-y-0'}
        `}>
